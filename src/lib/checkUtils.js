...
export function printChecks(checks, targetWindow) {
  ...
  win.document.write(`<html><head><title>Check Print</title><style>*{box-sizing:border-box}body{margin:0;font-family:'Courier New',monospace}.check{width:8.5in;height:3.5in;position:relative;page-break-after:always}.date{position:absolute;top:.48in;right:.55in;font-size:11px}.payee{position:absolute;top:1.28in;left:1.55in;right:2.15in;font-size:13px;font-weight:bold;white-space:nowrap;overflow:hidden}.amount{position:absolute;top:1.22in;right:.42in;font-size:14px;font-weight:bold}.words{position:absolute;top:1.72in;left:.55in;right:.45in;font-size:11px;font-weight:bold}.memo{position:absolute;bottom:.48in;left:.55in;max-width:4.5in;font-size:10px}@page{size:8.5in 3.5in;margin:0}@media print{.check:last-child{page-break-after:auto}}</style></head><body>${checks.map(checkMarkup).join("")}</body></html>`);
