...
export default function Dashboard() {
  ...
  const totalIncome = transactions.filter(t => t.type === "income" && t.category !== "fund_transfer" && t.category !== "bank_reconciliation").reduce((s, t) => s + (t.amount || 0), 0);
  const totalExpenses = transactions.filter(t => t.type === "expense" && t.category !== "fund_transfer" && t.category !== "bank_reconciliation").reduce((s, t) => s + (t.amount || 0), 0);
